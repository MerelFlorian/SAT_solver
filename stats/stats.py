...
print(data_panda)
print("RM ANOVA \n", pg.rm_anova(data = data_panda, dv = "value",within = "variable", subject = "ID", effsize = "np2", detailed = False, correction = 'auto'), "\n")

# post hoc
print("POST HOC \n", pg.pairwise_tests(dv = "value", within = "variable", subject = "ID", data = data_panda))
...
print("non parametric data\n", data_panda.groupby(['variable'])['value'].agg(['median', iqr, q25, q75, min, max]).round(2))
