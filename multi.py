...
if __name__ == "__main__":
    ...
    with open("stats.csv", "w") as f:
        ...
        writer.writerows([[f"{'DPLL' if i == 1 else 'JW' if i == 2 else 'MOM'},{r[0]}" if n == 0 else r[0] for n, r in enumerate(result[j:int((i*TOTAL/3))])] for i,j in zip(range(1,4), range(0, TOTAL, 1011))])
